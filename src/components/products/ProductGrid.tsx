...
//           <div
//             key={i}
//             className="bg-white dark:bg-slate-800 rounded-xl shadow-sm overflow-hidden animate-pulse border border-slate-200 dark:border-slate-700"
//           >
...
//           <motion.div
//             key={products.length} // Use products.length as key to trigger animation on filter changes
