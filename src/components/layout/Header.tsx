      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/" className="flex items-center">
          <div className="relative pr-3">
            ...
            <div className="relative bg-gradient-to-br from-purple-00 via-pink-400 to-orange-500 p-3 rounded-2xl shadow-lg transform group-hover:scale-105 transition-transform duration-300">
